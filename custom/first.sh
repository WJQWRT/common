...
if [[ -n "${BENDI_VERSION}" ]]; then
  ...
  sudo rm -rf build/common && git clone -b main --depth 1 https://github.com/WJQWRT/common build/common
...
git clone -b main --depth 1 https://github.com/WJQWRT/build-actions shangyou
...
curl -fsSL https://raw.githubusercontent.com/WJQWRT/common/main/common.sh -o common.sh
if [[ $? -ne 0 ]]; then
...
if [[ -n "${BENDI_VERSION}" ]]; then
  ...
  export GIT_REPOSITORY="WJQWRT/build-actions"
  sudo rm -rf build common.sh
